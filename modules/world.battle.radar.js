...
module.exports.displayNukeTab = function (gameTime, shard) {
  module.ajaxGet("https://screeps.com/api/experimental/nukes", function (data) {
    if (data.error) {
      $("#sc-tbody-battle-radar").append(
        `<div style='position: absolute;right: 50%;font-size: 16px;padding-top: 10px;''>${data.error}</div>`
      );
    } else if (!shard) {
      $("#sc-tbody-battle-radar-pvp").append(
        `<div style='position: absolute;right: 50%;font-size: 16px;padding-top: 10px;''>Failed to read shard.</div>`
      );
    } else if (data.nukes[shard].length === 0) {
      $("#sc-tbody-battle-radar").append(
        "<div style='position: absolute;right: 50%;font-size: 16px;padding-top: 10px;''> The world is at peace.</div>"
      );
    } else {
...
module.exports.getBadgeSvg = function (badge, width, height) {
  ...
  m.push({
    index: n++,
    rgb: "#" + module.exports.dataToRgb(0, 0, 0.8)
  });
  for (var o = 0; 19 > o; o++) {
    m.push({
      index: n++,
      rgb: "#" + module.exports.dataToRgb((360 * o) / 19, 0.6, 0.8)
    });
  }
  m.push({
    index: n++,
    rgb: "#" + module.exports.dataToRgb(0, 0, 0.5)
  });
  for (var o = 0; 19 > o; o++) {
    m.push({
      index: n++,
      rgb: "#" + module.exports.dataToRgb((360 * o) / 19, 0.7, 0.5)
    });
  }
  m.push({
    index: n++,
    rgb: "#" + module.exports.dataToRgb(0, 0, 0.3)
  });
  for (var o = 0; 19 > o; o++) {
    m.push({
      index: n++,
      rgb: "#" + module.exports.dataToRgb((360 * o) / 19, 0.4, 0.3)
    });
  }
  m.push({
    index: n++,
    rgb: "#" + module.exports.dataToRgb(0, 0, 0.1)
  });
  for (var o = 0; 19 > o; o++) {
    m.push({
      index: n++,
      rgb: "#" + module.exports.dataToRgb((360 * o) / 19, 0.5, 0.1)
    });
  }
...
module.exports.dataToRgb = function b(a, b, c) {
  ...
  var e,
    f,
    g,
    h = (1 - Math.abs(2 * c - 1)) * b,
    i = a / 60,
    j = h * (1 - Math.abs((i % 2) - 1));
  void 0 === a || isNaN(a) || null === a
    ? (e = f = g = 0)
    : i >= 0 && 1 > i
    ? ((e = h), (f = j), (g = 0))
    : i >= 1 && 2 > i
  ...
  return {
    ...
    3: {
      calc: function (a) {
        ...
        (this.path1 =
          "M 50 50 L " +
          (50 + 100 * Math.cos(c - b / 2)) +
          " " +
          (50 + 100 * Math.sin(c - b / 2)) +
          " L " +
          (50 + 100 * Math.cos(c + b / 2)) +
          " " +
          (50 + 100 * Math.sin(c + b / 2)) +
          ...
          (this.path2 =
            "M 50 50 L " +
            (50 + 100 * Math.cos(d - b / 2)) +
            " " +
            (50 + 100 * Math.sin(d - b / 2)) +
            " L " +
            (50 + 100 * Math.cos(d + b / 2)) +
            " " +
            (50 + 100 * Math.sin(d + b / 2)) +
            " Z\n                          M 50 50 L " +
            (50 + 100 * Math.cos(e - b / 2)) +
            " " +
            (50 + 100 * Math.sin(e - b / 2)) +
            " L " +
            (50 + 100 * Math.cos(e + b / 2)) +
            " " +
            (50 + 100 * Math.sin(e + b / 2)));
    ...
    16: {
      calc: function (a) {
        var b = (30 * Math.PI) / 180,
          c = 25;
        a > 0 && (b += (((30 * Math.PI) / 180) * a) / 100), 0 > a && (c += (25 * a) / 100), (this.path1 = "");
        for (var d = 0; 3 > d; d++) {
    ...
    22: {
      calc: function (a) {
        ...
        (b += (10 * a) / 100),
          (this.path1 =
            "M " + (50 - b) + " " + (50 - b) + " H " + (50 + b) + " V " + (50 + b) + " H " + (50 - b) + " Z"),
          (this.path2 = "");
        for (var c = -4; 4 > c; c++)
          for (var d = -4; 4 > d; d++) {
            var e = (c + d) % 2;
    ...
    23: {
      calc: function (a) {
        var b = 17,
          c = 25;
        a > 0 && (b += (35 * a) / 100), 0 > a && (c -= (23 * a) / 100), (this.path1 = "");
        for (var d = -4; 4 >= d; d++)
          this.path1 +=
            "M " +
            (50 - b * d * 2) +
    ...
    24: {
      calc: function (a) {
        ...
        a > 0 && (b += (60 * a) / 100),
          ...
          (this.path2 =
            "M 50 0 L " + (50 + b) + " 100 H 100 V " + c + " L 50 70 L 0 " + c + " V 100 H " + (50 - b) + " Z");
      },
      flip: "rotate180"
    }
  };
